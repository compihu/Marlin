...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 675   // Unload filament length from hotend in mm
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 674     // Load filament length over hotend in mm
