...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 660   // Unload filament length from hotend in mm
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 660     // Load filament length over hotend in mm
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT 480       // Turn off nozzle if user doesn't change filament within this time limit in seconds
