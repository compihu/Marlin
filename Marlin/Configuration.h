...
#define DELTA
  ...
  #define DELTA_HEIGHT 296.62// get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0, -0.323, -0.761} // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 133.91 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.261, 0.353, -0.092 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 962 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300,300,300, 55 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -19.00   // Z offset: -below +above  [the nozzle]
